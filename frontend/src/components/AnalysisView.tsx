  ...
  return (
    <div className="space-y-16">
      ...
      <section id="summary" className="scroll-mt-24">
        ...
        <Reveal>
          <div className="glass-card rounded-2xl p-6 text-lg leading-relaxed text-slate-200">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {data.techStack.map((t, i) => (
              <Reveal key={t.name} delay={i * 60}>
                <div className="glass-card flex gap-3 rounded-xl p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {data.folders.map((f, i) => (
            <Reveal key={f.path} delay={i * 50}>
              <div className="glass-card h-full rounded-xl p-5 transition hover:border-indigo-400/40">
                <div className="flex items-center gap-2">
